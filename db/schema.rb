...
ActiveRecord::Schema.define(version: 2018_12_10_233910) do
  ...
  create_table "comissions", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "sale_id"
  ...
  create_table "discounts", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.integer "value"
    t.integer "kind"
  ...
  create_table "product_quantities", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "product_id"
    t.integer "quantity"
    t.bigint "user_id"
    t.datetime "created_at", null: false
